...
public class DBUtil {
    ...
    public static String db_password="xk0819";//数据库的密码
    public static Connection getConn()//获取连接，返回Connection类型，必须设置为static这样才能在其他类中使用
    {
        ...
        try
        {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/servlet", "root", "xk0819");
            System.out.println("XK Connecting......");
        }
        catch(Exception e)
        {
        	System.out.println("XK Connecting failure!");
            e.printStackTrace();
        }
        System.out.println("XK Connect Successing");
        return conn;
    }
